    ...
    <main id="listening-speaking-app" className="container mx-auto max-w-4xl px-4 py-10">
      <header className="mb-8 space-y-4">
        <div className="space-y-2">
          <p className="text-sm font-medium text-primary">Listening & Speaking</p>
          <h1 className="text-3xl font-bold tracking-tight">Pratique cada fala</h1>
          <p className="max-w-2xl text-muted-foreground">
            Ouça a frase, repita em voz alta e confira a transcrição e seu percentual de acerto.
          </p>
        </div>
